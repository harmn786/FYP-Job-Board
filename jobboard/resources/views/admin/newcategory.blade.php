...
@endif
  ...
  <div class="card border-0 shadow mb-4 rounded p-4">
    <div class="card-body p-4">
      ...
      <form action="{{ route('addCategory') }}" class="" method="POST">
        @csrf
        <div class="row mt-4">
        <div class="mb-3 col-md-6 ">
            <label for="name" class="form-label">Enter Category Name</label>
            <input type="text" value="{{old('name')}}" class="form-control @error('name') is-invalid  @enderror" id="name" name="name" placeholder="Enter Category Name">
