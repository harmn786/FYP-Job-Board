  ...
  <div class="card border-0 shadow mb-4">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
          ...
          <select name="job_type" value="{{old('job_type',$job->type)}}" class="selectpicker border rounded  @error('job_type') is-invalid  @enderror" id="job_type" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Job Type">
        ...
        <div class="form-group">
          ...
          <select name="experience"  value="{{old('experience',$job->experience)}}" class="selectpicker border rounded @error('experience') is-invalid  @enderror" id="experience" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Years of Experience">
        ...
        <div class="form-group">
          ...
          <select name="gender"  value="{{old('gender',$job->gender)}}"  class="selectpicker border rounded @error('gender') is-invalid  @enderror" id="gender" data-style="btn-black" data-width="100%" data-live-search="true" title="Select Gender">
